...
# - manifest_dir: path to directory containing cargo manifest (relative to current folder, or absolute)
...
function(apply_cargokit target manifest_dir lib_name any_symbol_name)
    ...
    # Resolve manifest dir — handle both relative and absolute paths
    if(IS_ABSOLUTE "${manifest_dir}")
        set(CARGOKIT_MANIFEST_DIR_RESOLVED "${manifest_dir}")
    else()
        set(CARGOKIT_MANIFEST_DIR_RESOLVED "${CMAKE_CURRENT_SOURCE_DIR}/${manifest_dir}")
    endif()

    set(CARGOKIT_ENV
        "CARGOKIT_CMAKE=${CMAKE_COMMAND}"
        "CARGOKIT_CONFIGURATION=$<CONFIG>"
        "CARGOKIT_MANIFEST_DIR=${CARGOKIT_MANIFEST_DIR_RESOLVED}"
